...
const HALT_MAP = new Map([
  ...
  [
    'model-role-resolution-failed',
    {
      terminal: true,
      resume_hint:
        'Fix `.codex-paired/project.json` `models` or the `CODEX_PAIRED_*` environment values, then re-run.',
    },
  ],
  [
    'model-role-conflicting-args',
    {
      terminal: true,
      resume_hint:
        'Remove conflicting model flags, or fix `.codex-paired/project.json` `models` / `CODEX_PAIRED_*`, then re-run.',
    },
  ],
  [
    'implementer-attempt-lost',
    {
      terminal: true,
      resume_hint:
        'Inspect `.codex-paired/attempts/` for the lost direct-CLI attempt, recover its worktree if needed, then re-run.',
    },
  ],
  [
    'implementer-attempt-timeout',
    {
      terminal: true,
      resume_hint:
        'Inspect the live attempt recorded under `.codex-paired/attempts/`; wait for or stop it before resuming.',
    },
  ],
  [
