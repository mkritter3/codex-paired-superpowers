 ...
 *
 * @param {string} specPath
 * @param {{phase?: string, sliceId?: string}} [filter] phase is required at runtime (validated below)
 * @returns {object[]}
 */
 ...
 */
/** @param {string} specPath @param {{phase?: string, sliceId?: string}} [filter] @returns {JsonObject[]} */
export function readExpertTurns(specPath, filter = {}) {
  return readReviewerTurns(specPath, filter);
}
