...
export function appendRound(specPath, round, opts = {}) {
  ...
  if (opts.enforceShipAudits) assertShipAuditsForAppend(sc, round, { headSha: opts.headSha });
