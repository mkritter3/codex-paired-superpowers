...
/** @typedef {{phase?: string, round?: number, side?: 'claude' | 'codex'}} AuditFilter */
/**
 ...
 * @returns {object[]}
 */
export function readReviewerTurns(specPath, filter = /** @type {{phase: string, sliceId?: string}} */ ({})) {
...
export function readExpertTurns(specPath, filter = /** @type {{phase: string, sliceId?: string}} */ ({})) {
