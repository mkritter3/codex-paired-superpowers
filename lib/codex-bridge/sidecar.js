...
/** @typedef {import('./types.js').Audit} Audit */
 ...
 */
/** @param {string} specPath @param {string} sliceId @param {JsonObject} meta */
 ...
 */
/** @param {string} specPath @param {string} sliceId @param {JsonObject} bootstrap */
 ...
 */
/** @param {string} specPath @param {JsonObject} sel */
 ...
 */
/** @param {string} specPath @param {JsonObject} rec */
 ...
 */
/** @param {string} specPath @param {JsonObject} locator @param {string} findingId @param {JsonObject} update */
 ...
 */
/** @param {string} specPath @param {string} sliceId @param {string} taskId @param {JsonObject} terminal */
export function finalizeImplementDispatch(specPath, sliceId, taskId, terminal) {
  ...
  for (const field of ['model_role', 'model', 'effort']) {
 ...
 */
/** @param {string} specPath @param {JsonObject} graphBlock */
 ...
 */
/** @param {string} specPath @param {JsonObject} goalsBlock */
 ...
 * @param {object} audit
 */
/** @param {string} specPath @param {Audit | JsonObject} audit */
 ...
 */
/** @param {string} specPath @param {JsonObject} [filter] @returns {JsonObject[]} */
 ...
 */
/** @param {string} specPath @param {JsonObject} [filter] */
...
/** @param {JsonObject} audit @returns {JsonObject} */
 ...
 */
/** @param {string} specPath @param {{audits?: JsonObject[], round?: JsonObject}} [entries] @param {{headSha?: string, sequential?: boolean, budget?: boolean}} [opts] */
...
/** @param {string} sliceId @param {JsonObject} run */
 ...
 * @param {string} specPath
 * @param {string} sliceId — e.g. "slice-3"
 * @param {{base_sha:string, members:Record<string, JsonObject>}} run
 * @param {JsonObject} deps — optional dep injection (lockfile override for tests)
 * @returns {Promise<{implementer_run_id:string}>}
 */
/** @param {string} specPath @param {string} sliceId @param {JsonObject} run @param {JsonObject} [deps] */
export async function startImplementerRun(specPath, sliceId, run, deps = {}) {
  ...
  return withSidecarLock(specPath, async () => {
    ...
    for (const [memberId, m] of Object.entries(run.members)) {
      ...
      for (const key of ['owner', 'runtime_kind', 'overlap_rationale']) {
 ...
 */
/** @param {string} specPath @param {string} sliceId @param {string} implementerRunId @param {JsonObject} result @param {JsonObject} [deps] */
